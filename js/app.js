...
module.exports = function () {
  ...
  return {
    ...
    renderNotesLists: function renderNotesLists(params, callback) {
      helpers.curlget('/pm/note', params, callback);
    },
...
module.exports = function () {
  ...
  return {
    ...
    getContacts: function getContacts(params, callback) {
      helpers.curlgetapi(API_SERVICE_URL + '/crm/contacts', params, callback);
    },
    getNotificationTemplate: function getNotificationTemplate(params, callback) {
      helpers.curlgetapi(API_SERVICE_URL + '/crm/notification-templates', params, callback);
    },
    suggestNotificationTemplate: function suggestNotificationTemplate(dom, params) {
      helpers.select2AjaxSearch(dom, API_SERVICE_URL + '/crm/notification-templates', params, {
        term: 'name',
        id: 'template_id',
        text: 'name'
      });
    ...
    getNotificationTemplateDetail: function getNotificationTemplateDetail(params, callback) {
      ...
      helpers.curlgetapi(API_SERVICE_URL + '/crm/notification-templates/' + template_id, params, callback);
    },
    ...
    findAccountDetail: function findAccountDetail(params, callback) {
      helpers.curlgetapi(API_SERVICE_URL + '/crm/accounts/find', params, callback);
    },
    getContactDetail: function getContactDetail(params, callback) {
      var contact_id = params.contact_id;
      delete params.contact_id;
      helpers.curlgetapi(API_SERVICE_URL + '/crm/contacts/' + contact_id, params, callback);
    },
    getOpportunitiesDetail: function getOpportunitiesDetail(params, callback) {
      ...
      helpers.curlgetapi(API_SERVICE_URL + '/crm/opportunities/' + opportunity_id, params, callback);
    },
    getOpportunities: function getOpportunities(params, callback) {
      helpers.curlgetapi(API_SERVICE_URL + '/crm/opportunities', params, callback);
    },
    getCalendar: function getCalendar(params, callback) {
      helpers.curlgetapi(API_SERVICE_URL + '/crm/calendars', params, callback);
    },
    getContactToSale: function getContactToSale(params, callback) {
      helpers.curlgetapi(API_SERVICE_URL + '/crm/contacts-to-sales', params, callback);
    },
    ...
    select2NotificationTemplateFormat: function select2NotificationTemplateFormat(data, selected) {
      ...
      return result; // if (callback && typeof(callback) === "function") {
      //     callback(response);
      // }
    },
...
module.exports = function () {
  ...
  return {
    ...
    getCourses: function getCourses(params, callback) {
      helpers.curlgetapi(API_SERVICE_URL + '/edu/courses/', params, callback);
    },
    ...
    getClasses: function getClasses(params, callback) {
      helpers.curlgetapi(API_SERVICE_URL + '/edu/classes', params, callback);
    },
    getCalendar: function getCalendar(params, callback) {
    ...
    getStudentsByClass: function getStudentsByClass(params, callback) {
      helpers.curlget(API_SERVICE_URL + '/edu/classes/' + params.class_id + '/students', params, callback);
    }
  };
}();
...
module.exports = function () {
  ...
  return {
    getProfiles: function getProfiles(params, callback) {
      helpers.curlgetapi(API_SERVICE_URL + '/hr/employees', params, callback); // helpers.curlget(API_SERVICE_URL + '/hr/employees',params,callback);
    },
    getNotificationTemplate: function getNotificationTemplate(params, callback) {
...
module.exports = function () {
  ...
  return {
    ...
    censorshipItem: function censorshipItem(url, params, callback) {
      var self = this;
      $.confirm({
        title: 'Confirm!',
        ...
        confirmButtonClass: 'btn-danger',
        confirm: function confirm() {
          self.curlpost(url, params, function (response) {
            if (response.error || response.status == 'error') {
              show_notify_error(response);
              return false;
            }
      ...
      $(dom).select2({
        ...
        ajax: {
          ...
          processResults: function processResults(data) {
            ...
            console.log(results); // Transforms the top-level key of the response object from 'items' to 'results'
...
module.exports = function () {
  ...
  // }
  return {
    calculator: function calculator(params, callback) {
      helpers.curlpost('/finance/invoices/caculator', params, callback);
    },
    paymentUpdateStatus: function paymentUpdateStatus(params, callback) {
      helpers.curlput('/finance/invoices/' + params.invoice_id + '/payment/' + params.payment_id, params, callback);
    },
    paymentCalculator: function paymentCalculator(params, callback) {
      helpers.curlpost('/finance/invoices/' + params.invoice_id + '/payment/calculator', params, callback);
    },
    getInvoices: function getInvoices(params, callback) {
    ...
    getInvoicesDetail: function getInvoicesDetail(params, callback) {
      ...
      helpers.curlget('/finance/invoice/' + invoice_id, params, callback);
    }
  };
}();
...
module.exports = function () {
  ...
  return {
    getBranchDetail: function getBranchDetail(params, callback) {
      ...
      helpers.curlgetapi(API_SERVICE_URL + '/org/brand-branches/' + branch_id, params, callback);
    },
    getBranchs: function getBranchs(params, callback) {
      helpers.curlgetapi(API_SERVICE_URL + '/org/brand-branches', params, callback);
    },
    getBranchsByBrands: function getBranchsByBrands(params, callback) {
      var brand_id = params.brand_id;
      delete params.brand_id;
      helpers.curlgetapi(API_SERVICE_URL + '/org/brands/' + brand_id + '/brand-branches', params, callback);
    },
    getBrandsByBranch: function getBrandsByBranch(params, callback) {
      var branch_id = params.branch_id;
      delete params.branch_id;
      helpers.curlgetapi(API_SERVICE_URL + '/org/brand-branches/' + branch_id + '/brands', params, callback);
    },
...
__webpack_require__(/*! D:\code\erp-service\erp-static\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! D:\code\erp-service\erp-static\resources\sass\app.scss */"./resources/sass/app.scss");
