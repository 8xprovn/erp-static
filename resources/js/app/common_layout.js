$(document).ready(function () {
    var objMenu = {
        ...
        'recruitment': '<div class="col-4">\
                    <a href="https://erp.ebomb.edu.vn/recruitment" class="d-block text-body text-center ripple-dark rounded p-3 load_not_ajax">\
                        <i class="icon-profile text-success icon-2x"></i>\
                        <div class="font-size-sm font-weight-semibold text-uppercase mt-2">Tuyển dụng</div>\
                    </a>\
                </div>',
        'app': '<div class="col-4">\
        ...
        'task': '<div class="col-4">\
                    <a href="https://erp.ebomb.edu.vn/task" class="d-block text-body text-center ripple-dark rounded p-3 load_not_ajax">\
                        <i class="icon-task text-success icon-2x"></i>\
                        <div class="font-size-sm font-weight-semibold text-uppercase mt-2">Công việc</div>\
                    </a>\
                </div>',
        'test': '<div class="col-4">\
                    <a href="https://erp.ebomb.edu.vn/tests" class="d-block text-body text-center ripple-dark rounded p-3 load_not_ajax">\
                        <i class="icon-task text-success icon-2x"></i>\
        ...
        'target': '<div class="col-4">\
            <a href="https://erp.ebomb.edu.vn/target/me-target" class="d-block text-body text-center ripple-dark rounded p-3 load_not_ajax">\
                <i class="icon-target text-success icon-2x"></i>\
                <div class="font-size-sm font-weight-semibold text-uppercase mt-2">KPIs</div>\
            </a>\
        </div>',
        'support': '<div class="col-4">\
            <a href="https://erp.ebomb.edu.vn/support" class="d-block text-body text-center ripple-dark rounded p-3 load_not_ajax">\
                <i class="icon-folder text-success icon-2x"></i>\
                <div class="font-size-sm font-weight-semibold text-uppercase mt-2">Support</div>\
            </a>\
        </div>',
    }
